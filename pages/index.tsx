...
const lol = ["Backend Developer", "Engineering Student", "Chess Enthusiast"];
...
const Home: NextPage = () => {
  ...
  return (
    <NonSSRWrapper>
      <main className="bg-[#121316] z-20 flex flex-col justify-start items-center">
        <section className="w-full h-screen flex flex-col justify-start items-center ">
          <div className="h-[10%] w-full">
            <Nav />
          </div>
          <div className="container h-[90%] w-[95%] flex">
            <div className="w-[29%] h-full flex flex-col justify-center items-start">
              <div className="flex flex-col gap-6">
                <div className="bg-gradient-to-r from-[#0078DF] to-[#246BAA] text-2xl w-max rounded-2xl">
                  <p className="py-2 pl-3 pr-5 font-bold">
                    Welcome , I&rsquo;m
                  </p>
                </div>
                <div className="flex justify-center items-center relative w-full">
                  <div className="relative border-[#4D88FF] border-[0.7rem] h-56 w-56">
                    <div className="absolute h-56 w-56 border-[#4D88FF] border-b-[0.7rem] top-[-0.7rem] left-[-0.7rem] z-20"></div>
