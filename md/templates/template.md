...
**1. Flexibility**: With such low-level and fine-grained control, data retrieval tasks are only constrained by how good a developer is with SQL. Since SQL itself is an extremely powerful language, an application can harvest the full potential of its data.
...
## How do I use an ORM to build this website?
...
Check out how I uses `Prisma` on Github:
<https://github.com/nathan20021/summer-portfolio/tree/main/pages/api>
